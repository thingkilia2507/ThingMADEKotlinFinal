package com.thing.bangkit.thingmadekotlinfinal.core.adapter
...
class SectionPagerAdapter(activity: AppCompatActivity, private var pageType : Int= 0) : FragmentStateAdapter(activity) {
    ...
    override fun createFragment(position: Int): Fragment {
        val fragment : Fragment = if(pageType == 0) {
            Class.forName("com.thing.bangkit.thingmadekotlinfinal.fragment.FilmFragment")
                .newInstance() as Fragment
        }else{
            Class.forName("com.thing.bangkit.thingmadekotlinfinal.favorites.fragment.FilmFavFragment")
                .newInstance() as Fragment
        }
