...
class FilmFragment: Fragment() {
    ...
    companion object{
        private val ARG_POSITION_BUNDLE = "BUNDLE_POSITION"
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(requireActivity(), ViewModelProvider.NewInstanceFactory())[FilmViewModel::class.java]
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        films = if(arguments?.getInt(ARG_POSITION_BUNDLE) == 0) viewModel.getGenerateMoviesData(requireContext()) else viewModel.getGenerateTvShowData(requireContext())
        if(films.size >0){
